...
LABEL ca.unb.lib.generator="dspace" \
  ...
  org.label-schema.description="digipres.dspace.lib.unb.ca provides object storage for The digipres instance at UNB Libraries." \
  org.label-schema.name="digipres.dspace.lib.unb.ca" \
  org.label-schema.schema-version="1.0" \
  org.label-schema.vcs-ref=$VCS_REF \
  org.label-schema.vcs-url="https://github.com/unb-libraries/digipres.dspace.lib.unb.ca" \
  org.label-schema.vendor="University of New Brunswick Libraries" \
  org.label-schema.version=$VERSION \
  org.opencontainers.image.source="https://github.com/unb-libraries/digipres.dspace.lib.unb.ca"
